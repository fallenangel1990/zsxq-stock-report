...
{news_text}"""
        ...
        result = client.create(
            system="你是一位资深财经分析师和风险管理顾问，擅长从全球市场新闻中提炼投资信号和风险预警。你的简报帮助投资者在开盘前快速把握机会、规避风险。你对风险信号特别敏感，会从新闻中识别回调、监管、资金外流等风险因素。",
            prompt=prompt,
            max_tokens=1200,
        )
...
> - 以上信息仅供参考，不构成任何投资建议
> - 股市有风险，投资需谨慎
> - 盘中走势受多种因素影响，请结合自身风险承受能力做出独立判断
> - 建议单只股票仓位不超过总资金的 20%，单一行业不超过 40%
> - 设置好止损位，严格执行纪律
